                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <h6 class="font-size-15 mt-3 mb-1"><a href="user-profile.html"
                                                class="text-primary employee-name">{{$employe->name}}</a></h6>
                                                ...
                                                <div class="text-center border-end p-3">
                                                    <h6 class="font-size-14 mb-0">
                                                        <a href="javascript: void(0);"
                                                            ...
                                                            data-bs-original-title="{{$employe->email}}">
                                                            <i
...
<script>
    document.getElementById('search-bar').addEventListener('keyup', function() {
        const query = this.value.toLowerCase(); // Récupère la valeur de la recherche en minuscule
        const users = document.querySelectorAll('.employee-item'); // Sélectionne tous les éléments utilisateurs

        users.forEach(function(user) {
            const name = user.querySelector('.employee-name').textContent.toLowerCase(); // Récupère le nom de l'utilisateur
            if (name.includes(query)) {
                user.style.display = 'block'; // Affiche l'utilisateur si le nom contient la recherche
            } else {
                user.style.display = 'none'; // Masque l'utilisateur si le nom ne correspond pas
            }
        });
    });
</script>    
