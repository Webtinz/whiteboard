...
<!-- Mirrored from preview.pichforest.com/probic/layouts/auth-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Oct 2024 11:26:09 GMT -->
<head>

    <meta charset="utf-8" />
    <title>Sign up | Probic - Responsive Bootstrap 5 Admin Dashboard</title>
                ...
                <div class="row justify-content-center my-auto">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <div class="form-checkbox d-flex">
                                                    ...
                                                    <label class="form-label text-muted font-size-13"
                                                        for="customControlInline">By registering you agree to the Probic
                                                        <span class="text-primary">Terms of Use</span></label>
                                                </div>
                                            </div><!-- end col -->
                                        </div><!-- end row -->
                        ...
                        <div class="mt-3 text-center text-muted">
                            <p class="mb-0">Already have an account ? <a href="{{ route('login') }}" class="fw-medium">
                                    Signin now </a></p>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
