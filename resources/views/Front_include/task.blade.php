...
<div class="main-content">
                    ...
                    <div class="d-md-flex">
                            ...
                            <div class="card-body">
                                <div>
                                    <a href="#" class="btn btn-soft-primary w-100 shadow-none"
                                        data-bs-toggle="modal" onclick="addTask()"
                                        data-bs-target=".bs-example-new-task"><i class="mdi mdi-plus me-1"></i>Add
                                        New Task</a>
                                </div>
                                ...
                                <div class="tasks-list mt-1">
                                    <a href="#"><span class="mdi mdi-autorenew text-muted me-1"></span>Pending Tasks
                        ...
                        <div class="w-100">
                            ...
                            <div id="all-task">
                                                    ...
                                                    <div class="col-xl-6 col-sm-5">
                                                        <div class="checklist form-check font-size-15">
                                                            ...
                                                            <label class="form-check-label ms-1 task-title"
                                                                for="customCheck1">Create a New Landing</label>
                                                        </div>
                                                    </div><!-- end col -->
                                                    ...
                                                    <div class="col-xl-6 col-sm-5">
                                                        <div class="checklist form-check font-size-15">
                                                            <input type="checkbox" class="form-check-input"
                                                                id="customCheck2">
                                                            <label class="form-check-label ms-1 task-title"
                                                                for="customCheck2">Create a Layout Design</label>
                                                        </div>
                                                    </div><!-- end col -->
                                                    <div class="col-xl-6 col-sm-7">
                                                        <div class="row align-items-center">
                                                    ...
                                                    <div class="col-xl-6 col-sm-5">
                                                        <div class="checklist form-check font-size-15">
                                                            <input type="checkbox" class="form-check-input"
                                                                id="customCheck3">
                                                            <label class="form-check-label ms-1 task-title"
                                                                for="customCheck3">Create a Blog Template UI</label>
                                                        </div>
                                                    </div><!-- end col -->
                                                    <div class="col-xl-6 col-sm-7">
                                                        <div class="row align-items-center">
                                                                ...
                                                                <div class="avatar-group mt-3 mt-xl-0 task-assigne">
                                                                    ...
                                                                    <div class="avatar-group-item">
                                                                        <a href="javascript: void(0);"
                                                                            ...
                                                                            data-bs-toggle="tooltip"
                                                                            data-bs-placement="top"
                                                                            value="member-10" title="Betty Cooney">
                                                    ...
                                                    <div class="col-xl-6 col-sm-5">
                                                        <div class="checklist form-check font-size-15">
                                                            <input type="checkbox" class="form-check-input"
                                                                id="customComponents">
                                                            <label class="form-check-label ms-1 task-title"
                                                                for="customComponents">Components Pages</label>
                                                        </div>
                                                    </div><!-- end col -->
                                                    <div class="col-xl-6 col-sm-7">
                                                        <div class="row align-items-center">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-xl-6 col-sm-5">
                                                        <div class="checklist form-check font-size-15">
                                                            ...
                                                            <label class="form-check-label ms-1 task-title"
                                                                for="customGallry">Create a Gallery Pages</label>
                                                        </div>
                                                    </div><!-- end col -->
                                                    <div class="col-xl-6 col-sm-7">
                                                        <div class="row align-items-center">
                                ...
                                <div class="task-list-box" id="about-task">
                                    <div id="task-item-7">
                                        <div class="card list-group-item rounded-3">
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    <div class="col-xl-6 col-sm-5">
                                                        <div class="checklist form-check font-size-15">
                                                            <input type="checkbox" class="form-check-input"
                                                                id="customDesign">
                                                            <label class="form-check-label ms-1 task-title"
                                                                for="customDesign">Design the about Pages</label>
                                                        </div>
                                                    </div><!-- end col -->
                                                    <div class="col-xl-6 col-sm-7">
                                                        <div class="row align-items-center">
                                                                ...
                                                                <div class="avatar-group mt-3 mt-xl-0 task-assigne">
                                                                    ...
                                                                    <div class="avatar-group-item">
                                                                        <a href="javascript: void(0);"
                                                                            ...
                                                                            data-bs-toggle="tooltip"
                                                                            data-bs-placement="top"
                                                                            value="member-10" title="Jansh Wells">
                                                                            <img src="assets/images/users/avatar-10.jpg"
                                                                                alt=""
                                                                                class="rounded-circle avatar-sm">
                                                                        </a>
                                                                    ...
                                                                    <div class="avatar-group-item">
                                                                        <a href="javascript: void(0);"
                                                                            class="d-inline-block"
                                                                            data-bs-toggle="tooltip"
                                                                            data-bs-placement="top" value="member-2"
                                                                            title="Denny Silva">
                                                                            <img src="assets/images/users/avatar-2.jpg"
                                                                                alt=""
                                                                                class="rounded-circle avatar-sm">
                                                            ...
                                                            <div class="col-xl-7 col-md-6 col-sm-7">
                                                                <div
                                                                    ...
                                                                    <div>
                                                                        <a href="#"
                                                                            class="mb-0 text-muted fw-medium"><i
                                                                                class="mdi mdi-checkbox-marked-circle-outline me-1"></i>6/11
                                                                        </a>
                                                                    </div>
                                                                    <div>
                                                                        <a href="#"
                                                                            ...
                                                                            data-bs-target=".bs-example-new-task"><i
                                                                                class="mdi mdi-square-edit-outline font-size-16 align-middle"
                                                                                onclick="editTask('task-item-7')"></i></a>
                                                                    </div>
                                                                    <div>
                                                                        <a href="#" class="delete-item"
                                                                            onclick="deleteProjects('task-item-7')">
                                                                            <i
                                                                                class="mdi mdi-trash-can-outline font-size-16 align-middle text-danger"></i>
                                                                        </a>
                                                                    </div>
                                ...
                                <div class="task-list-box" id="ecom-task">
                                    <div id="task-item-8">
                                        <div class="card list-group-item rounded-3">
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    <div class="col-xl-6 col-sm-5">
                                                        <div class="checklist form-check font-size-15">
                                                            <input type="checkbox" class="form-check-input"
                                                                id="customEcommerce">
                                                            <label class="form-check-label ms-1 task-title"
                                                                for="customEcommerce">Ecommerce App</label>
                                                        </div>
                                                    </div><!-- end col -->
                                                    <div class="col-xl-6 col-sm-7">
                                                        <div class="row align-items-center">
                                                                ...
                                                                <div class="avatar-group mt-3 mt-xl-0 task-assigne">
                                                                    <div class="avatar-group-item">
                                                                        <a href="javascript: void(0);"
                                                                            class="d-inline-block"
                                                                            data-bs-toggle="tooltip"
                                                                            value="member-3" data-bs-placement="top"
                                                                            title="Amy Hanna">
                                                                            <img src="assets/images/users/avatar-3.jpg"
                                                                                alt=""
                                                                                class="rounded-circle avatar-sm">
                                                                    ...
                                                                    <div class="avatar-group-item">
                                                                        <a href="javascript: void(0);"
                                                                            class="d-inline-block"
                                                                            data-bs-toggle="tooltip"
                                                                            data-bs-placement="top" value="member-9"
                                                                            title="Alfred Taylor">
                                                                            <img src="assets/images/users/avatar-9.jpg"
                                                                                alt=""
                                                                                class="rounded-circle avatar-sm">
                                                                    ...
                                                                    <div class="avatar-group-item">
                                                                        <a href="javascript: void(0);"
                                                                            class="d-inline-block" value="member-6"
                                                                            data-bs-toggle="tooltip"
                                                                            data-bs-placement="top"
                                                                            title="Alan Hannah">
                                                                            <img src="assets/images/users/avatar-6.jpg"
                                                            ...
                                                            <div class="col-xl-7 col-md-6 col-sm-7">
                                                                <div
                                                                    ...
                                                                    <div>
                                                                        <a href="#"
                                                                            class="mb-0 text-muted fw-medium"><i
                                                                                class="mdi mdi-checkbox-marked-circle-outline me-1"></i>0/14
                                                                        </a>
                                                                    </div>
                                                                    <div>
                                                                        <a href="#"
                                                                            ...
                                                                            data-bs-target=".bs-example-new-task"><i
                                                                                class="mdi mdi-square-edit-outline font-size-16 align-middle"
                                                                                onclick="editTask('task-item-8')"></i></a>
                                                                    </div>
                                                                    <div>
                                                                        <a href="#" class="delete-item"
                                                                            onclick="deleteProjects('task-item-8')">
                                                                            <i
                                                                                class="mdi mdi-trash-can-outline font-size-16 align-middle text-danger"></i>
                                                                        </a>
                                                                    </div>
                                ...
                                <div class="task-list-box" id="brand-task">
                                    <div id="task-item-9">
                                        <div class="card list-group-item rounded-3">
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    <div class="col-xl-6 col-sm-5">
                                                        <div class="checklist form-check font-size-15">
                                                            <input type="checkbox" class="form-check-input"
                                                                id="customBrand">
                                                            <label class="form-check-label ms-1 task-title"
                                                                for="customBrand">Brand Logo Design</label>
                                                        </div>
                                                    </div><!-- end col -->
                                                    <div class="col-xl-6 col-sm-7">
                                                        <div class="row align-items-center">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div>
                                                                        <a href="#"
                                                                            ...
                                                                            data-bs-target=".bs-example-new-task"><i
                                                                                class="mdi mdi-square-edit-outline font-size-16 align-middle"
                                                                                onclick="editTask('task-item-9')"></i></a>
                                                                    </div>
                                                                    <div>
                                                                        <a href="#" class="delete-item"
                                                                            onclick="deleteProjects('task-item-9')"><i
                                                                                class="mdi mdi-trash-can-outline font-size-16 align-middle text-danger"></i></a>
                                                                    </div>
                                                                </div>
                                                            </div><!-- end col -->
                                                        </div><!-- end row -->
    ...
    <!-- Add Newtask Modal -->
    <div class="modal fade bs-example-new-task" tabindex="-1" role="dialog" aria-labelledby="addNewtaskModal"
        aria-hidden="true">
                            ...
                            <div id="sub-tasks" class="mt-1">
                                <div>
                                    <div id="subtask-item-4">
                                        <div
                                            class="checklist px-0 d-flex form-check align-items-center font-size-16">
