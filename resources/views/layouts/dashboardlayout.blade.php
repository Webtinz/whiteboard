...
<head>
    ...
    <link href="{{ asset('assets/libs/prismjs/plugins/toolbar/prism-toolbar.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('assets/libs/prismjs/plugins/line-numbers/prism-line-numbers.css') }}" rel="stylesheet"
        type="text/css" />
