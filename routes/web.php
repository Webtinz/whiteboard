...
// Route::middleware('auth')->group(function () {
    ...
    Route::post('/tasks/{task}/files', [ProjectTaskController::class, 'uploadFiles'])->name('tasks.upload_files');
    Route::delete('/tasks/files/{file}', [ProjectTaskController::class, 'deleteFile'])->name('tasks.delete_file');
